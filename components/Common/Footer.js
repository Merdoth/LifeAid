...
const Footer = () => (
    <React.Fragment>
        ...
        <div className="footer">
            <div className="footer1 home-footer1 about-footer1 service-footer1 article-footer1 article-content-footer1 app-content" id="contact">
            ...
            <div className="footer2 home-footer2 about-footer2 service-footer2 article-footer2 article-content-footer2 app-content">
